...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=28 * 28, latent_dim=20):
        ...
        self.encoder=nn.Sequential(
            nn.Linear(self.input_size, self.hparams["n_hidden_en"]),
            nn.LeakyReLU(),
...
class Autoencoder(nn.Module):
    ...
    def forward(self, x):
        ...
        reconstruction=self.decoder(encode)
        pass
    ...
    def set_optimizer(self):
        ...
        self.optimizer = torch.optim.SGD(self.parameters(), lr=self.hparams["learning_rate"], momentum=0.9)
        pass
...
class Classifier(nn.Module):
    ...
    def set_optimizer(self):
        ...
        self.optimizer = torch.optim.Adam(list(self.encoder.parameters()),lr=self.hparams["learning_rate"])
